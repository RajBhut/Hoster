...
func (tu *TaskUpdate) SetUser(s string) *TaskUpdate {
	tu.mutation.SetUser(s)
	return tu
}

// SetNillableUser sets the "user" field if the given value is not nil.
func (tu *TaskUpdate) SetNillableUser(s *string) *TaskUpdate {
	if s != nil {
		tu.SetUser(*s)
	}
	return tu
...
func (tu *TaskUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.User(); ok {
		_spec.SetField(task.FieldUser, field.TypeString, value)
	}
...
// SetUser sets the "user" field.
func (tuo *TaskUpdateOne) SetUser(s string) *TaskUpdateOne {
	tuo.mutation.SetUser(s)
	return tuo
}

// SetNillableUser sets the "user" field if the given value is not nil.
func (tuo *TaskUpdateOne) SetNillableUser(s *string) *TaskUpdateOne {
	if s != nil {
		tuo.SetUser(*s)
	}
	return tuo
